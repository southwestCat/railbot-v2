 ...
 * @param source The source joint request. All angles != JointAngles::ignore
 * will be copied.
 ...
 * @param to The second source joint request. This one has to be reached over
 * time.
...
void interpolate(const JointRequest &from, const JointRequest &to,
                 float fromRatio, JointRequest &target,
 ...
 */
bool interpolate(JointRequest &joints, const float alpha, const float threshold,
                 const JointRequest &theJointRequest,
                 const JointAngles &theJointAngles,
                 const JointRequest &theStandLegRequest);

void interpolate(const JointAngles &from, const JointRequest &to, float &ratio,
                 JointRequest &target, const JointAngles &theJointAngles);
